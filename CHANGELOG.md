...
All notable changes to the PeroseMart project are documented in this file.
...
- **Classical Premium UI Design System**:
  - Deep emerald, dusty rose gold, and clean canvas neutrals with classical typography — rebranded as PeroseMart.
