...
class UserDAOTest extends BaseDAOTest {
    ...
    void testSaveAndFindUser() throws DatabaseException {
        User user = new User();
        user.setName("Perose Test");
        user.setEmail("perose@test.com");
        ...
        Optional<User> foundByEmail = userDAO.findByEmail("perose@test.com");
        assertTrue(foundByEmail.isPresent());
        assertEquals("Perose Test", foundByEmail.get().getName());
        ...
        assertEquals("perose@test.com", foundById.get().getEmail());
    }
