 ...
 * Serves the application at: http://localhost:8080/perosemart
 */
public class TomcatServer {
    ...
    public static void start(int port) throws Exception {
        ...
        Context ctx = tomcat.addWebapp("/perosemart", docBase.getAbsolutePath());
        ...
        ctx.addApplicationListener("com.perose.perosemart.listener.AppContextListener");

        System.out.println(">>> Apache Tomcat 9 running at: http://localhost:" + port + "/perosemart");
        tomcat.start();
    }
