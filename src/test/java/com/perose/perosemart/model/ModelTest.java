...
class ModelTest {
    ...
    void testUserModel() {
        ...
        User user = new User(1L, "Perose User", "perose@test.com", "super_secret_bcrypt_hash", Role.SELLER, true, now);

        assertEquals(1L, user.getId());
        assertEquals("Perose User", user.getName());
        assertEquals("perose@test.com", user.getEmail());
        ...
        User user2 = new User(1L, "Perose User", "perose@test.com", "other_hash", Role.SELLER, true, now);
        ...
        assertTrue(toString.contains("Perose User"));
        assertTrue(toString.contains("perose@test.com"));
    }
