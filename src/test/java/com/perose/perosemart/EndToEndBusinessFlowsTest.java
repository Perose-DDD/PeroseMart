...
public class EndToEndBusinessFlowsTest {
    ...
    private static final String BASE_URL = "http://localhost:" + TEST_PORT + "/perosemart";
    ...
    void testBuyerAuth() throws Exception {
        ...
        String form = "email=buyer1@perosemart.com&password=buyer123&_csrf=" + csrf;
    ...
    void testSellerAuth() throws Exception {
        ...
        String form = "email=seller1@perosemart.com&password=seller123&_csrf=" + csrf;
    ...
    void testAdminAuth() throws Exception {
        ...
        String form = "email=admin@perosemart.com&password=admin123&_csrf=" + csrf;
    ...
    void testAdminUsers() throws Exception {
        ...
        assertEquals(200, res.status);
        assertTrue(res.body.contains("Registered Accounts"));
        assertTrue(res.body.contains("buyer1@perosemart.com"));
        assertTrue(res.body.contains("seller1@perosemart.com"));
    }
