package com.perose.perosemart.dto;
...
class DtoTest {
    ...
    void testUserResponseSecurity() {
        ...
        User user = new User(1L, "Perose", "perose@test.com", "secret_hash", Role.SELLER, true, now);

        UserResponse userResponse = UserResponse.fromUser(user);
        assertNotNull(userResponse);
        assertEquals(1L, userResponse.getId());
        assertEquals("Perose", userResponse.getName());
        assertEquals("perose@test.com", userResponse.getEmail());
