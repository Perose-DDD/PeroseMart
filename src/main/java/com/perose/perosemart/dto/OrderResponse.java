    ...
    public static OrderResponse fromOrder(Order order, List<?> items) {
        ...
        if (items != null) {
            for (Object obj : items) {
                ...
                } else if (obj instanceof com.perose.perosemart.model.OrderItem) {
                    responseItems.add(OrderItemResponse.fromOrderItem((com.perose.perosemart.model.OrderItem) obj));
                }
            }
        }
