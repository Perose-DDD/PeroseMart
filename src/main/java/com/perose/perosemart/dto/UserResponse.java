...
public class UserResponse implements Serializable {
    ...
    public UserResponse(Long id, String name, String email, com.perose.perosemart.model.Role role, Timestamp createdAt) {
        this(id, name, email, role != null ? role.name() : null, true, createdAt);
    }

    public UserResponse(Long id, String name, String email, com.perose.perosemart.model.Role role, Boolean isActive, Timestamp createdAt) {
