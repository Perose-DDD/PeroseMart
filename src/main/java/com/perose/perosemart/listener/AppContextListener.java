package com.perose.perosemart.listener;

import com.perose.perosemart.util.DatabaseMigrationRunner;
...
public class AppContextListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        logger.info("Initializing PeroseMart Application Context and HikariCP connection pool...");
        try {
            ...
            if (jdbcUrl == null || jdbcUrl.trim().isEmpty()) {
                jdbcUrl = props.getProperty("db.url", "jdbc:h2:mem:perosemart;DB_CLOSE_DELAY=-1;MODE=PostgreSQL");
            }
            ...
            config.setPoolName("PeroseMartHikariPool");
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        logger.info("Closing PeroseMart HikariCP connection pool...");
