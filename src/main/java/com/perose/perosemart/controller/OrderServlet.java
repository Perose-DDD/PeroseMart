...
import com.perose.perosemart.dto.OrderResponse;
import com.perose.perosemart.dto.UserResponseDTO;
import com.perose.perosemart.exception.AuthenticationException;
import com.perose.perosemart.exception.ValidationException;
import com.perose.perosemart.model.Order;
import com.perose.perosemart.model.OrderItem;
...
public class OrderServlet extends BaseServlet {
    ...
    private com.perose.perosemart.service.CartService cartService;
    ...
    public OrderServlet(OrderService orderService, com.perose.perosemart.service.CartService cartService) {
        this.orderService = orderService;
    ...
    public void init() {
        ...
        if (this.cartService == null) {
            this.cartService = new com.perose.perosemart.service.impl.CartServiceImpl(new CartDAOImpl(), new ProductDAOImpl());
        }
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            if ("/checkout".equals(servletPath)) {
                if (cartService != null) {
                    List<com.perose.perosemart.dto.CartItemDTO> cartItems = cartService.getCart(user.getId());
