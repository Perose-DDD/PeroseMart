...
<head>
    ...
    <title><c:out value="${pageTitle != null ? pageTitle : 'PeroseMart — Curated Classical Marketplace'}" /></title>
    <meta name="description" content="PeroseMart - Premium Multi-Seller Marketplace built on Java Servlets, H2, and Tomcat.">
    <meta name="_csrf" content="${csrfToken}">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/main.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/components.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/layout.css">
    <link rel="icon" type="image/svg+xml" href="${pageContext.request.contextPath}/assets/img/logo.svg">
</head>
<body>
...
<header class="site-header">
    <div class="container header-inner">
        <!-- Brand Logo -->
        <a href="${pageContext.request.contextPath}/home" class="brand-logo" aria-label="PeroseMart Home">
            <img src="${pageContext.request.contextPath}/assets/img/logo.svg" alt="PeroseMart logo" class="brand-symbol">
            <span class="brand-name">Perose<span>Mart</span></span>
        </a>
