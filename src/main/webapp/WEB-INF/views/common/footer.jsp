...
<footer class="site-footer">
        ...
        <div class="container footer-grid">
            <div class="footer-col">
                <div class="brand-logo" style="margin-bottom: var(--space-4);">
                    ...
                    <span class="brand-name" style="color: #ffffff;">Perose<span style="color: var(--color-accent);">Mart</span></span>
                </div>
    ...
    <div class="footer-bottom">
        <div class="container">
            <p>&copy; 2026 PeroseMart. Academic Capstone Project. Engineered with classical precision.</p>
        </div>
    </div>
</footer>
